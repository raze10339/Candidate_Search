      ...
      {candidate ? (
        <div style={{ display: 'inline-block', backgroundColor: '#000', padding: '20px', borderRadius: '10px', maxWidth: '400px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '20px' }}>
            <button onClick={handleReject} style={{ backgroundColor: 'red', color: '#FFF', border: 'none', borderRadius: '50%', width: '50px', height: '50px', fontSize: '24px', marginRight: '20px', cursor: 'pointer' }}>-</button>
            <button onClick={handleSave} style={{ backgroundColor: 'green', color: '#FFF', border: 'none', borderRadius: '50%', width: '50px', height: '50px', fontSize: '24px', cursor: 'pointer' }}>+</button>
          </div>
        </div>
      ) : (
